...
<p style="font-size:12px;color:#64748b;margin-top:4px">Allergen data by <a href="${siteUrl}" target="_blank" rel="noopener">${site}</a></p>`;
  ...
  return (
    <div className="mt-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
      ...
      <pre className="text-xs bg-white p-3 rounded border border-slate-200 overflow-x-auto whitespace-pre-wrap break-all text-slate-600">
        {embedCode}
      </pre>
      <button
        onClick={handleCopy}
        className="mt-2 px-3 py-1.5 text-xs font-medium bg-green-700 text-white rounded-md hover:bg-green-800 transition-colors cursor-pointer"
      >
