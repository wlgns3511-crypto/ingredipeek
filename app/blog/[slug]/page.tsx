  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            author: {
              "@type": "Person",
              name: "IngredIPeek Food Science Team",
              description: "Nutrition science and food ingredient research",
              url: "https://ingredipeek.com/about/",
              worksFor: {
                "@type": "Organization",
                name: "IngredIPeek",
                url: "https://ingredipeek.com",
              },
            },
            publisher: {
              "@type": "Organization",
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://ingredipeek.com/blog/${slug}/`,
            },
          }),
        }}
      />
      ...
      <nav className="text-xs text-slate-500 mb-6">
        ...
        <a href="/blog/" className="hover:text-green-700">Guides</a>
        <span className="mx-1">›</span>
      ...
      <header className="mb-8">
        ...
        <div className="text-xs text-slate-400 flex items-center gap-3">
          ...
          <span>· IngrediPeek Editorial Team</span>
        </div>
      </header>
      ...
      <div className="mt-12 p-6 bg-green-50 border border-green-200 rounded-xl">
        ...
        <p className="text-slate-600 text-sm mb-4">
          Use our free ingredient checker to identify allergens, additives, and
          dietary flags in thousands of food products.
        </p>
        <div className="flex flex-wrap gap-3">
          <a
            href="/checker/"
            className="text-sm px-4 py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 font-medium"
          >
            Ingredient Checker
          </a>
          <a
            href="/allergen/gluten-free/"
            className="text-sm px-4 py-2 bg-white border border-green-300 text-green-700 rounded-lg hover:bg-green-50 font-medium"
          >
            Gluten-Free Foods
          </a>
          <a
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {suggestions.map((p) => (
              <a
                key={p.slug}
                href={`/blog/${p.slug}/`}
                className="block border border-slate-200 rounded-xl p-4 hover:border-green-300 hover:shadow-sm transition-all group"
              >
                <span className="text-xs text-green-700">{p.category}</span>
                <h3 className="text-sm font-semibold text-slate-900 group-hover:text-green-700 mt-1 leading-snug">
                  {p.title}
                </h3>
